...
namespace HardCoded.VRigUnity.Updated
{
  ...
  public class AppSettings : ScriptableObject
  {
    ...
    [SerializeField] private Mediapipe.Unity.Logger.LogLevel _logLevel = Mediapipe.Unity.Logger.LogLevel.Debug;
    ...
    public Mediapipe.Unity.Logger.LogLevel logLevel => _logLevel;
